    ...
    private static void divempty(String url) {
        try {
            ...
            for (Element div : divs) {
                // Obținem textul propriu-zis din div
                String text = div.ownText().trim();

                // Verificăm dacă div-ul este gol (fără copii, fără text sau conține doar "...")
                if (div.children().isEmpty() && (text.isEmpty() || text.equals("..."))) {
